...
//                     }))
//                   }
//                   placeholder="거주지와 자신 있는 분야를 간단히 소개해주세요"
//                 />
//               </div>
//               <div className="space-y-2">
...
//                 <div className="space-y-2">
//                   <Label>산업기초안전교육 이수증 *</Label>
//                   <div className="border-2 border-dashed p-6 text-center">
//                     <FileText className="mx-auto h-8 w-8 mb-2" />
//                     <input
//                       type="file"
//                       accept="image/*,.pdf"
//                       onChange={handleFileChange("safetyCard")}
//                       className="hidden"
//                       id="safetyCard"
//                     />
//                     <Label htmlFor="safetyCard" className="cursor-pointer">
//                       {formData.safetyCard
//                         ? formData.safetyCard.name
//                         : "파일 선택 또는 드래그"}
//                     </Label>
//                   </div>
//                 </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  placeholder="거주하시는 지역과 주특기를 알려주세요. 예: 경기도 성남 / 전기 배관 작업"
                />
              </div>
              <div className="space-y-2">
                <Label htmlFor="phone">전화번호 *</Label>
